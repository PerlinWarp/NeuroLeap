...
def animate(i):
	...
	if (points is not None):
		...
		if hand.is_valid:
			...
			for finger in range(0,5):
				for bone in range(0,3):
					...
					x = X[finger*bone+bone] + 50 * math.sin(pitch) #+ finger*20 + bone*10
					y = Y[finger*bone+bone] + 50*math.sin(pitch)*math.sin(yaw) #+ finger*20 + bone*10
					z = Y[finger*bone+bone] + 50*math.cos(pitch) #+ finger*20 + bone*10
		...
		# Plot Angle points
		nl.plot_points(a_points, angle_plot)
		print(a_points)
